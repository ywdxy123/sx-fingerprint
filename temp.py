import os
os.chdir(r'C:\Users\user\Desktop\Project\Position_project\Fingerprint\Fingerprint_zhujiang\test')
import math
import time
...
if __name__ == '__main__':
    ...
    res_data = forecast.userdata[['time','servingcell', 'longitude', 'latitude', 'lng_pre', 'lat_pre']]
    res_data.to_csv('result1.csv', index=False)
